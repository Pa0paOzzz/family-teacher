...
export const adminApi = {
  ...
  getJobPosts: () => api.get('/admin/job-posts'),
  getJobPostById: (id) => api.get(`/admin/job-posts/${id}`),
  updateJobPostStatus: (id, data) => api.put(`/admin/job-posts/${id}/status`, data),
  updateJobPost: (id, data) => api.put(`/admin/job-posts/${id}`, data),
  deleteJobPost: (id) => api.delete(`/admin/job-posts/${id}`),
  getTutoringRequests: () => api.get('/admin/tutoring-requests'),
  getTutoringRequestById: (id) => api.get(`/admin/tutoring-requests/${id}`),
  updateTutoringRequestStatus: (id, data) => api.put(`/admin/tutoring-requests/${id}/status`, data),
  updateTutoringRequest: (id, data) => api.put(`/admin/tutoring-requests/${id}`, data),
  deleteTutoringRequest: (id) => api.delete(`/admin/tutoring-requests/${id}`),
